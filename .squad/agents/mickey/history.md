...
- 2026-05-27T06:19:33-04:00 -- Planned #455/#456 (governance chores). Key finding: Select-String phrase-echo vs full-section-duplicate distinction matters. `decisions.md` "2 copies" was phrase appearing in both H2 header and body paragraph (not a true full-block duplicate). Batching disjoint single-file chores on one branch is clean when they share labels, reviewer, and domain. Plan at `.squad/decisions/inbox/mickey-chore-plan-455-456.md`.
