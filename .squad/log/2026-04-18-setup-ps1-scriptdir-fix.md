...
[x] Fixed setup.ps1 line 51: Replaced `$MyInvocation.MyCommand.Path` with `$PSScriptRoot` + `$MyInvocation.MyCommand.Definition` fallback  
[x] Decision documented: goofy-scriptroot-fix.md merged to decisions.md  
[x] Goofy's history.md updated  
[x] Changes committed
