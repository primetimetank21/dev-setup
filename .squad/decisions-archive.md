...
Entries archived from .squad/decisions.md per the size-gated 7-day rule.
Cut point: 2026-05-17 fold (decisions.md was 164,339 bytes; rule fires at >= 51,200 bytes).
All entries below were dated on or before 2026-05-04 (older than 7 days at fold time).
Original chronology + formatting preserved. Append-only.
